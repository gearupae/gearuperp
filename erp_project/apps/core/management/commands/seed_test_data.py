...
class Command(BaseCommand):
    ...
    def seed_projects(self):
        ...
        projects_data = [
            ('ERP Implementation Phase 1', 'software', 500000),
            ('ERP Implementation Phase 2', 'software', 400000),
            ('Mobile App Development', 'software', 300000),
            ('Website Redesign', 'software', 150000),
            ('Cloud Migration', 'software', 250000),
            ('Network Infrastructure', 'software', 180000),
            ('Security Audit', 'consulting', 80000),
            ('Process Automation', 'software', 200000),
            ('Data Analytics Platform', 'software', 350000),
            ('CRM Integration', 'software', 120000),
            ('E-commerce Platform', 'software', 280000),
            ('HR System Implementation', 'software', 160000),
            ('Finance System Upgrade', 'software', 190000),
            ('Inventory Management', 'software', 140000),
            ('Supply Chain Optimization', 'consulting', 220000),
            ('Quality Management System', 'consulting', 110000),
            ('Training Program', 'training', 90000),
            ('Change Management', 'consulting', 130000),
            ('Digital Transformation', 'consulting', 450000),
            ('IoT Implementation', 'software', 320000),
            ('AI/ML Development', 'software', 380000),
            ('Blockchain Solution', 'software', 270000),
            ('API Integration', 'software', 95000),
            ('Database Optimization', 'software', 75000),
            ('Server Migration', 'software', 110000),
            ('Disaster Recovery Setup', 'software', 145000),
            ('Compliance Audit', 'consulting', 85000),
            ('Performance Optimization', 'consulting', 70000),
            ('User Training', 'training', 60000),
            ('Documentation Project', 'consulting', 45000),
            ('System Integration', 'software', 185000),
            ('Legacy Modernization', 'software', 290000),
            ('DevOps Implementation', 'software', 170000),
            ('Agile Transformation', 'consulting', 120000),
            ('Customer Portal', 'software', 195000),
            ('Vendor Portal', 'software', 165000),
            ('Employee Portal', 'software', 145000),
            ('Business Intelligence', 'software', 230000),
            ('Reporting System', 'software', 95000),
            ('Dashboard Development', 'software', 85000),
            ('Mobile Optimization', 'software', 75000),
            ('SEO Implementation', 'consulting', 55000),
            ('Content Management', 'software', 105000),
            ('Knowledge Base', 'software', 65000),
            ('Help Desk System', 'software', 115000),
            ('Ticketing System', 'software', 90000),
            ('Asset Management', 'software', 130000),
            ('Facility Management', 'software', 155000),
            ('Project Management Tool', 'software', 140000),
            ('Collaboration Platform', 'software', 175000),
        ]
        
        created = 0
        for i, (name, proj_type, value) in enumerate(projects_data):
